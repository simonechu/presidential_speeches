...
i2017_topten <- i2017_sentiment %>%
  ...
  labs(title = "The Top 10 Most Used Words in Donald Trump's Inaugural Address (2017)",
       fill = "Sentiment") + 
...
i2009_topten <- i2009_sentiment %>%
  ...
  xlab("Word") + 
  ylab("Number of Instances") + 
  labs(title = "The Top 10 Most Used Words in Barack Obama's First Inaugural Address (2009)",
       fill = "Sentiment") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
i2001_topten <- i2001_sentiment %>%
  ...
  xlab("Word") + 
  ylab("Number of Instances") + 
  labs(title = "The Top 10 Most Used Words in George W. Bush's First Inaugural Address (2001)",
       fill = "Sentiment") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
i1993_topten <- i1993_sentiment %>%
  ...
  xlab("Word") + 
  ylab("Number of Instances") + 
  labs(title = "The Top 10 Most Used Words in Bill Clinton's First Inaugural Address (2009)",
       fill = "Sentiment") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
